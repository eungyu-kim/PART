...
/**
 * Created by kug00 on 2017-11-05.
 */

public class shoppingActivity extends AppCompatActivity {
    TextView shopping_title, shopping_addr, shopping_intro, TextView_shopping_Infocenter, TextView_shopping_parking, TextView_shopping_Restdateleports,
            TextView_shopping_Usetimeleports;

    //쇼핑 정보 소개 가져오기
    String shopping_Intro_Data, shopping_Data;
    //쇼핑 정보를 담기위한 해쉬 리스트 선언
    ArrayList<HashMap<String, String>> shopping_S_ListHash;
    //받는 정보 분류
    int contentTypeId;
    //JSON에서 목록을 만들기위한 배열
    private static final String Detail_SID="contentid", Detail_Title = "title", Detail_address = "addr1", Detail_Image = "firstimage"
            ,Overview = "overview",Infocenter = "infocentershopping", Parking = "parkingshopping",Restdateleports = "restdateshopping"
            ,Usetimeleports = "opentime";

    String shopping_contentId;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //아이디 찾기
        shopping_title = (TextView) findViewById(R.id.shopping_title);
        shopping_addr = (TextView) findViewById(R.id.shopping_addr);
        shopping_intro = (TextView) findViewById(R.id.shopping_intro);
        TextView_shopping_Infocenter = (TextView) findViewById(R.id.TextView_shopping_Infocenter);
        ...
        //Id 얻기
        shopping_contentId = DetailHash.get(Detail_SID);
        ...
        Picasso.with(this)
                .load(detail_img)
                .into((ImageView) findViewById(R.id.shopping_img));
    ...
    protected void showList() {
        try {
            ...
            JSONObject jsonObj = new JSONObject(shopping_Intro_Data);
            ...
            shopping_intro.setText(Html.fromHtml(OverviewValue));
    ...
    protected String LeisueIntroURL() {
        ...
        String mid = "&contentTypeId=" + contentTypeId + "&contentId=" + shopping_contentId;
    ...
    protected void IntroShow() {
        try {
            ...
            //Json data -> JsonOject 변환
            JSONObject jsonObj = new JSONObject(shopping_Data);
            //JsonObject -> 하위 JsonObject Get
            String response = jsonObj.getString("response");
            //Log.d("Result","response 결과"+response);
            ...
            if (!InfocenterValue.equals(""))
                TextView_shopping_Infocenter.setText(Html.fromHtml(InfocenterValue));
            ...
            if (!ParkingValue.equals(""))
                TextView_shopping_parking.setText(Html.fromHtml(ParkingValue));
            ...
            if (!RestdateleportsValue.equals(""))
                TextView_shopping_Restdateleports.setText(Html.fromHtml(RestdateleportsValue));
            ...
            if (!UsetimeleportsValue.equals(""))
                TextView_shopping_Usetimeleports.setText(Html.fromHtml(UsetimeleportsValue));
